...
public class ReturnAttachmentGUICallback extends AbstractGUICallback {
    ...
    public ReturnAttachmentGUICallback(MailMenuGUIScreen screen, IncomingGUISection section, int width, int height) {
    ...
    public void init() {
        ...
        this.addElement(new OxygenGUIText(4, 5, ClientReference.localize("oxygen_mail.gui.mail.callback.returnAttachment"), GUISettings.get().getTextScale(), GUISettings.get().getEnabledTextColor()));
        this.addElement(new OxygenGUIText(6, 17, ClientReference.localize("oxygen_mail.gui.mail.callback.returnAttachment.request"), GUISettings.get().getSubTextScale(), GUISettings.get().getEnabledTextColor()));
