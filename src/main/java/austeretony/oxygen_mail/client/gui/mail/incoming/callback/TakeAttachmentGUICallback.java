...
public class TakeAttachmentGUICallback extends AbstractGUICallback {
    ...
    public void init() {
        ...
        this.addElement(new OxygenGUIText(4, 5, ClientReference.localize("oxygen_mail.gui.mail.callback.takeAttachment"), GUISettings.get().getTextScale(), GUISettings.get().getEnabledTextColor()));
        this.addElement(new OxygenGUIText(6, 17, ClientReference.localize("oxygen_mail.gui.mail.callback.takeAttachment.request"), GUISettings.get().getSubTextScale(), GUISettings.get().getEnabledTextColor()));
